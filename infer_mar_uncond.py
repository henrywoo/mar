...
model_mar = mar.__dict__[model_type](
    buffer_size=64,
...
model_mar.load_state_dict(state_dict)
model_mar.eval()  # important!
model_vae = AutoencoderKL(embed_dim=16, ch_mult=(1, 1, 2, 2, 4), ckpt_path="pretrained_models/vae/kl16.ckpt").cuda().eval()
